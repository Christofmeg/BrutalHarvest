...
public class ThrowingKnifeTrigger extends SimpleCriterionTrigger<ThrowingKnifeTrigger.TriggerInstance> {

    public static final ResourceLocation ID = new ResourceLocation(CommonConstants.MOD_ID, "throw_a_knife");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        public TriggerInstance(ContextAwarePredicate player) {
            super(ThrowingKnifeTrigger.ID, player);
        }
