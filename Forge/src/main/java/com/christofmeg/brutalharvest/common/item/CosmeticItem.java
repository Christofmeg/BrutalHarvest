...
public abstract class CosmeticItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public CosmeticItem(ArmorMaterial pMaterial, Type type, Properties pProperties) {
    ...
    @OnlyIn(Dist.CLIENT)
    protected abstract BrutalGeoArmorDefualRenderer<?> getRenderer();
