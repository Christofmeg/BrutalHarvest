...
public class BrutalFoods {
    ...
    public static final FoodProperties CORN_KERNEL = new FoodProperties.Builder().nutrition(1).saturationMod(1.4F).build();
    public static final FoodProperties CUCUMBER = new FoodProperties.Builder().build();
    public static final FoodProperties CUT_CUCUMBER = new FoodProperties.Builder().build();
    public static final FoodProperties PICKLES = new FoodProperties.Builder().build();
