...
public class ThrownScytheTrigger extends SimpleCriterionTrigger<ThrownScytheTrigger.TriggerInstance> {

    public static final ResourceLocation ID = new ResourceLocation(CommonConstants.MOD_ID, "reperang");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(ContextAwarePredicate player, ItemPredicate pItem) {
            super(ThrownScytheTrigger.ID, player);
            this.item = pItem;
        }
